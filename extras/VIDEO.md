...
`.venv/Scripts/python extras/video/shoot.py`. Edit the HTML and re-run to regenerate.
...
```bash
.venv/Scripts/python extras/video/build.py part4     # one part
.venv/Scripts/python extras/video/build.py C18       # one clip
.venv/Scripts/python extras/video/build.py final     # stitch everything
```
